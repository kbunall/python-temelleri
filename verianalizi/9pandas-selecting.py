...
# axis değeri x ve y koordinatlarını belirtiyor. 1 yukarıdan aşşa 0 dikey bir şekilde silinmesini sağlar.
# inplace parametresi de değişikliliğin tamamen kaydedilmesini sağlar.
