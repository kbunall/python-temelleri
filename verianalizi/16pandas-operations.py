...
result = df
result = df["Column2"].unique() # tekrarlananları eler
result = df["Column2"].nunique() # tekrarlananların sayısı belirlemek için kullanılır
result = df["Column2"].value_counts() # her bir elemanın kaç tane tekrarlandığını gösterir
result = df["Column1"] * 2 
